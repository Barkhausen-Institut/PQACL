...
inline bool verify_dec(const int& m, const int& l, const int& k, const std::string& json_data_export_path, const std::string& proof_path) {
    std::string runCommand = "./ZKP/zkstark_dec_verifier "  + std::to_string(m) +  " " + std::to_string(l) + " " +
